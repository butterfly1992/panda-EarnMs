...
<body>
	<div style="margin: 1em 10em 1em 10em;">
		<form action="entadsM_addent" method="post" enctype="multipart/form-data" id="form-page">
			<table id="devinfo" class="table table-bordered">
				<tr>
					<td class="tablecenter" colspan="4" style="height: 40px;">添加实体广告<s:actionerror cssStyle="color:red;list-style: none;"  theme="simple"/>
						<input type="hidden" name="ent.devicetype" value="${ent.devicetype }">
						<input type="hidden" name="ent.ordertype" value="${ent.ordertype }">
						</td>
				</tr>
