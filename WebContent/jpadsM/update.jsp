...
<body>
	<div style="margin: 1em 10em 1em 10em;">
		<form action="jpadsM_update" method="post" enctype="multipart/form-data" id="form-page">
			<table id="devinfo" class="table table-bordered">
				<tr>
					<td class="tablecenter" colspan="4" style="height: 40px;">修改精品广告<s:actionerror cssStyle="color:red;list-style: none;"  theme="simple"/>
					<input type="hidden" name="bou.id" value="${bou.id }">
					<input type="hidden" name="bou.adsindex" value="${bou.adsindex }">
			 ...
			 <c:if test="${bou.devicetype eq 'ios'}">
				...
				<tr style="height: 40px;">
					...
					<td style="width: 35%;">
					<s:select class="change" id="yd" name="bou.ydputtype" list="#{'0':'全国推行 ','1':'屏蔽','2':'投放','3':'全国屏蔽 ','3':'全国屏蔽 '}" value="bou.ydputtype" theme="simple"></s:select>
					</td>
				...
				<tr style="height: 40px;">
					<td class="tablecenter">状态</td>
					<td>
			        <s:radio name="bou.statues" list="#{'on':'上线','off':'下线'}" value="bou.statues" theme="simple"></s:radio>
 					</td>
					<td class="tablecenter">设备类型</td>
					<td>
				     <s:radio name="bou.devicetype" list="#{'ios':'苹果','android':'安卓'}" disabled="true" value="bou.devicetype" theme="simple"></s:radio>
 					</td>
				</tr>
...
<c:if test="${ bou.ydputtype eq 0 or bou.ydputtype eq 3}">
		<script type="text/javascript">
			$(function(){
			$(".yd").hide();
			});
	...
	<c:if test="${ bou.ltputtype eq 0 or bou.ltputtype eq 3}">
		<script type="text/javascript">
			$(function(){
			$(".lt").hide();
			});
	...
	<c:if test="${ bou.dxputtype eq 0 or bou.dxputtype eq 3}">
		<script type="text/javascript">
			$(function(){
			$(".dx").hide();
			});
