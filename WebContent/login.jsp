...
<div class="box">
		<div class="login-box">
			<div class="login-title text-center">
				<h1><small>生活赚后台管理系统</small></h1>
			</div>
			<div class="login-content ">
			<div style="text-align: center;color: red;"><s:actionmessage cssStyle="list-style-type:none;"/> </div>
			<div class="form">
			<form action="userM_login" method="post">
