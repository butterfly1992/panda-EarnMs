...
<body>
	<div style="margin: 1em 10em 1em 10em;">
		<form action="proadsM_add" method="post" enctype="multipart/form-data" id="form-page">
			<table id="devinfo" class="table table-bordered">
				<tr>
					<td class="tablecenter" colspan="4" style="height: 40px;">添加产品<s:actionerror cssStyle="color:red;list-style: none;"  theme="simple"/>
						<input type="hidden" name="ad.protype" value="${ad.protype }">
						<input type="hidden" name="ad.ordertype" value="${ad.ordertype }">
						</td>
				</tr>
			 ...
			 <c:if test="${ad.protype eq 'ios'}">
				<tr style="height: 40px;">
					...
					<td>
					  <input type="text" name="ad.iosrank" value="${ad.iosrank }" class="notnull" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" style="width: 100%;"> 
					</td>
				</tr></c:if>
				<tr style="height: 40px;">
				...
				<tr class="and" style="height: 40px;">
					...
					<td class="tablecenter">应用截图(两张)</td>
					<td>
