...
<body>
	<div style="margin: 3em 16em 4em 16em;">
		<form action="proadsM_upload" method="post" enctype="multipart/form-data" id="form-page">
			<table id="devinfo" class="table table-bordered">
			
				<tr>
					<td class="tableleft" colspan="8"
						style="text-align: center; height: 40px;">第一步</td>
				</tr>
				<tr style="height: 40px;">
					<td class="tableright" style="width: 10%;">平台类型</td>
					<td style="width: 15%;">
					<input type="radio" class="protype" name="ad.protype" value="android" checked="checked">安卓&nbsp;
					<input type="radio" class="protype" name="ad.protype" value="ios">IOS
